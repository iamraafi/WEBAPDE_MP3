        ...
        <div class="off-canvas-content" data-off-canvas-content>
		    <div class="top-bar">
		      <div class="row">
		        ...
		        <form action="/WEBAPDE_MP2/Search" method="post">
		          <ul class="menu">
  		...
  		<%}else{ %>
          <h1 id="album_title">no results</h1>
           </div><%}%>
        ...
        $(".thumbnail").click(function(){
            ...
            var title=document.getElementById("title"+this.id).value;
    	   	  ...
    	   	  for(var i=0;i<sharewith.length;i++){
    	   		  shared+="<input type='submit' style='background:none;cursor: pointer;border-width:0px;' value='"+sharewith[i]+"'/>";
    	   	  }
    		  ...
    		  var name=document.getElementById("owner"+this.id).value;
    	   	  var Thtml='<h3>'+title+' by:<form method="post" action="/WEBAPDE_MP2/LinkedUser"><input type="submit" name="USER" style="background:none;cursor: pointer;border-width:0px;"value='+name+'></a></h3>';
