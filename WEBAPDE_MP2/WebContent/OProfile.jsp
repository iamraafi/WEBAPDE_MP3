  ...
  <body>
    ...
    <div class="row">
      ...
      <div class="medium-6 large-5 columns">
		...
		<form action="/WEBAPDE_MP2/OPhotoCheck" method="post">
		<input type="hidden" name="store" value=<%=request.getAttribute("username")%>>
		<input type="submit" value="Photos" class="button large expanded">
		</form>
