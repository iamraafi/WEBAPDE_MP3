  ...
  <body>
    ...
    <div class="row">
      <div class="medium-6 columns">
      	<c:if test="${requestScope.photoprime !=null}">
	        <img class="thumbnail myImg" id="${requestScope.photoprime.getName()}" src="/WEBAPDE_MP2/image.html?id=<%=request.getAttribute("photoprimenum") %>">
	        <input type="hidden" id="profiletitle" value="${requestScope.photoprime.getName()}">
	 	</c:if>
	        
      </div>
    
      <div class="medium-6 large-5 columns">
        <h3><c:out value="${requestScope.username}"></c:out></h3>
        <p><c:out value="${requestScope.description}"></c:out></p>
