	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
	      ...
	      for(int i=0;i<cookies.length;i++){
	    	  ...
	    	  if(cookies[i].getName().equals("ID"))ID=cookies[i];
	      }
	      int k=Integer.parseInt(ID.getValue());
	      ...
	      request.setAttribute("Photos", ImageServices.OGphotos(k));
	      request.setAttribute("Shared", ImageServices.sharedphoto(k));
